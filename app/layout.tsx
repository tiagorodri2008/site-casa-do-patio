...
import './globals.css';
import './details.css';
export const metadata: Metadata = { metadataBase:new URL('https://site-casa-do-patio.vercel.app'), title:{default:'Restaurante português no Príncipe Real | Casa do Pátio',template:'%s — Casa do Pátio'}, description:'Cozinha portuguesa contemporânea, sazonal e para partilhar no Príncipe Real, Lisboa. Demonstração de restaurante fictício.', robots: {index:false, follow:false}, openGraph:{type:'website',siteName:'Casa do Pátio',images:[{url:'/images/courtyard-1600.webp',width:1600,height:900,alt:'Pátio acolhedor da Casa do Pátio'}]}, twitter:{card:'summary_large_image',images:['/images/courtyard-1600.webp']}, icons:{icon:'/favicon.svg'} };
